  ...
  '/notes/': [
    {
      ...
      items: [
        ...
        { text: 'Linux 文件属性及其相关命令', link: `/notes/01_linux_basic/06_${commonDirectoryName}/` },
        { text: 'Linux 标准输入输出和重定向', link: `/notes/01_linux_basic/07_${commonDirectoryName}/` },
        ...
        { text: 'Linux 进程管理', link: `/notes/01_linux_basic/13_${commonDirectoryName}/` },
        { text: 'Linux 服务管理', link: `/notes/01_linux_basic/14_${commonDirectoryName}/` },
        { text: 'Linux 磁盘管理', link: `/notes/01_linux_basic/15_${commonDirectoryName}/` },
        { text: 'Linux 正则表达式', link: `/notes/01_linux_basic/16_${commonDirectoryName}/` },
        { text: 'Linux 四剑客（二）', link: `/notes/01_linux_basic/17_${commonDirectoryName}/` },
        { text: 'Linux 定时任务', link: `/notes/01_linux_basic/18_${commonDirectoryName}/` },
